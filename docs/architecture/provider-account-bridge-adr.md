...
- CYRO-PROVIDER-008 adds a visible embedded provider feasibility shell for ChatGPT, Claude, and Gemini using Rust/Tauri allowlisted provider ids and origins.
