...
| CYRO-0002 | Sprint 0 Tauri desktop frontend shell | task/CYRO-0002-sprint0-tauri-shell | Ready for Review |  |  | Scope unchanged; mocked local runtime only |
| CYRO-DOCS-0003 | Provider Account Bridge requirements | task/CYRO-DOCS-0003-provider-account-bridge | Ready for Review |  |  | Docs/tracker only |
| CYRO-PROVIDER-001 | Provider Account Bridge ADR | Backlog | Planned |  |  | Defines provider session model, legal/security boundaries, and non-goals |
