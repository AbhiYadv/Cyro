...
import { ProviderShellLayout } from "../provider/ProviderShellLayout";
...
export function AppShell() {
  ...
  return (
    <div className="app-shell provider-app-shell">
      <ProviderShellLayout runtimeStatus={{ ...runtimeStatus, mode }} onRuntimeRefresh={refreshRuntimeStatus} />
    </div>
  );
}
